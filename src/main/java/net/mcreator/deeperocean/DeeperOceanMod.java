 ...
 *
 */
package net.mcreator.deeperocean;
...
@Mod("deeper_ocean")
public class DeeperOceanMod {
	public static final Logger LOGGER = LogManager.getLogger(DeeperOceanMod.class);
	public static final String MODID = "deeper_ocean";
	...
	public DeeperOceanMod() {
		...
		DeeperOceanModEntities.REGISTRY.register(bus);
